...
def clean_tweet( tweet): 
        ...
        return ' '.join(re.sub("(@[A-Za-z0-0]+)|([^0-9A-Za-z \t]) |(\w+:\/\/\S+)", " ", tweet).split()) 
...
def pred():
	if request.method=='POST':
            ...
            fetched = get_tweets(api,query, count) 
            return render_template('result.html', result=fetched)
...
if __name__ == '__main__':
    ...
    consumer_key = 'PkJG7l1OaM4bXcGxePMJRvRm1' 
    consumer_secret = 'YBmHEYhJ2CWGwKmEsrx3UbH0NnjZ05hOTovaeP0r4MHjMSXZyu'
    access_token = '1410039535153532933-TRAx8bDLk4IAg7dL27vZhvyB9yRltI'
    access_token_secret = 'EgwIT7ycRiEBv9FtpCLeBLq1qvaRZfFvVgu7mOtbfkZTb'
